...
// convert workers over a SharedArrayBuffer. Needs crossOriginIsolated (the
// host page must be served with COOP/COEP headers) + WebGPU +
// Atomics.waitAsync; anything missing
